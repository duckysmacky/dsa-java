import io.github.duckysmacky.dsa.collections.queue.ArrayQueue;
...
public class ArrayQueueTests {
    ...
    public void testAdd() {
        ...
        Executable addWhenAlreadyFull = () -> queue.add("more");
        assertThrows(IllegalStateException.class, addWhenAlreadyFull);
        assertFalse(queue.offer("more"));
